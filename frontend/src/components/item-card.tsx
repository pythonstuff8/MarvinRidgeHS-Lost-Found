                ...
                <div className="relative h-48 w-full bg-gray-100 overflow-hidden">
                    ...
                    {item.imageUrl ? (
                        ...
                        <div className="flex items-center justify-center h-full text-gray-300">
                            <Tag className="w-12 h-12 opacity-50" aria-hidden="true" />
                        </div>
                    )}
                ...
                <div className="p-5 space-y-3">
                    ...
                    <div className="pt-2 flex flex-col gap-2 text-xs text-gray-500">
                        <div className="flex items-center gap-1.5">
                            <Calendar className="w-3.5 h-3.5 text-fbla-blue" aria-hidden="true" />
                            <span>{item.date}</span>
                        </div>
                    </div>
                    ...
                    {hideActions ? null : role === "ADMIN" && item.status === "PENDING" ? (
                        ...
                        <Link
                            ...
                            className="block mt-4 w-full py-2.5 rounded-xl bg-gray-50 hover:bg-fbla-blue hover:text-white transition-colors font-medium text-sm text-gray-700 text-center"
                        >
                            View Details
                        </Link>
                    )}
